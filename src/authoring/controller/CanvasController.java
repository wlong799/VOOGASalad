...
public class CanvasController implements Observer {
    ...
    public void expand() {
        double width = myEnvironment.getCurrentLevel().getBoundary().getDimension().getWidth();
        width += Double.parseDouble(myCanvasProperties.getString("SCREEN_CHANGE_INTERVAL"));
        myEnvironment.getCurrentLevel().getBoundary().getDimension().setWidth(width);
        updateBackground();
    }
    ...
    public void taller() {
        double height = myEnvironment.getCurrentLevel().getBoundary().getDimension().getHeight();
        height += Double.parseDouble(myCanvasProperties.getString("SCREEN_CHANGE_INTERVAL"));
        myEnvironment.getCurrentLevel().getBoundary().getDimension().setHeight(height);
        updateBackground();
    }
