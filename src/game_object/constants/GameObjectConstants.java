...
public class GameObjectConstants {
	...
	public static final String FLAPPY_BIRD_FILE = "img/sprites/flappy_bird.png";
    public static final String WARP_PIPE_FILE = "img/sprites/warp_pipe.png";
    public static final String WARP_PIPE_DOWN_FILE = "img/sprites/warp_pipe_down.png";
	...
	public static final String SNAKE_FILE = "img/sprites/snake.png";
	public static final String SNOWMAN_FILE = "img/sprites/snowman.png";
	public static final String STONEMAN_FILE = "img/sprites/stoneman.png";
	public static final String WOOD_FILE = "img/sprites/wood.png";
	public static final String BLUE_SNAIL_FILE = "img/sprites/blue_snail_left.png";
	public static final String JAY_FILE = "img/sprites/jay.jpg";
	public static final String BILL_FILE = "img/sprites/bill.png";
	public static final String CHARLES_FILE = "img/sprites/charles.png";
